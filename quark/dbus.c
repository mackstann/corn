...
mpris_register_objects(DBusGConnection * bus)
{
    ...
    //MprisTrackList * tracklist = g_object_new(SOME_TYPE_OBJECT, NULL);
    ...
    //dbus_g_object_type_install_info(SOME_TYPE_OBJECT, &dbus_glib_PREFIX_FED_TO_DBUS_GLIB_TOOL_object_info);
